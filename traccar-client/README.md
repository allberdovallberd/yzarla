# [Yzarla app](https://www.traccar.org/client)
...
Yzarla is a GPS tracking app for Android and iOS. It runs in the background and sends location updates to your own server using the open-source Traccar platform.
